codeunit 80502 "PTK Library - ERM 4PS"
{
    ...
    var
        ...
        LibraryERMUnapply: Codeunit "PTK Library - ERM Unapply 4PS";
        ...
        LibraryMarketing: Codeunit "PTK Library - Marketing 4PS";
    ...
    procedure CreateGeneralJnlLine2WithBalAcc(var GenJournalLine: Record "Gen. Journal Line"; JournalTemplateName: Code[10]; JournalBatchName: Code[10]; DocumentType: Option; AccountType: Option; AccountNo: Code[20]; BalAccountType: Enum "Gen. Journal Account Type"; BalAccountNo: Code[20]; Amount: Decimal)
    begin
        // This function should replace the identical one above, but it requires a lot of changes to existing tests so I'm keeping both for now and will refactor when time permits
    ...
    begin
        case ContactType of
            ...
            IntrastatSetup."Intrastat Contact Type"::Vendor:
                exit(LibraryPurchase.CreateIntrastatContact(CreateCountryRegionWithIntrastatCode, false));
        end;
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeSetPostingGroupsOnPrepmtGLAccount(var LineGLAccount: Record "G/L Account"; var PrepmtGLAccount: Record "G/L Account"; GenPostingType: Enum "General Posting Type"; VATCalcType: Enum "Tax Calculation Type"; PrepmtVATCalcType: Enum "Tax Calculation Type"; var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetPostingGroupsOnPrepmtGLAccount(var LineGLAccount: Record "G/L Account"; var PrepmtGLAccount: Record "G/L Account"; GenPostingType: Enum "General Posting Type"; VATCalcType: Enum "Tax Calculation Type"; PrepmtVATCalcType: Enum "Tax Calculation Type")
    begin
    end;
