codeunit 80507 "PTK Library - Inventory 4PS"
{
    ...
    procedure CreateItemWithoutVAT(var Item: Record Item; IncludeUserWait: Boolean)
    var
        InventorySetup: Record "Inventory Setup";
    ...
    procedure CreateItem(var Item: Record Item; IncludeUserWait: Boolean): Code[20]
    var
        VATPostingSetup: Record "VAT Posting Setup";
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItemWithoutVAT(Item, IncludeUserWait);
    ...
    procedure CreateItemNo(IncludeUserWait: Boolean): Code[20]
    var
        Item: Record Item;
    begin
        CreateItem(Item, IncludeUserWait);
        exit(Item."No.");
    end;

    procedure CreateItemNoWithoutVAT(IncludeUserWait: Boolean): Code[20]
    var
        Item: Record Item;
    begin
        CreateItemWithoutVAT(Item, IncludeUserWait);
    ...
    procedure CreateItemWithTariffNo(var Item: Record Item; TariffNo: Code[20]; IncludeUserWait: Boolean)
    var
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    procedure CreateItemWithUnitPriceAndUnitCost(var Item: Record Item; UnitPrice: Decimal; UnitCost: Decimal; IncludeUserWait: Boolean)
    var
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    procedure CreateItemWithUnitPriceUnitCostAndPostingGroup(var Item: Record Item; UnitPrice: Decimal; UnitCost: Decimal; IncludeUserWait: Boolean)
    begin
        CreateItemWithUnitPriceAndUnitCost(Item, UnitPrice, UnitCost, IncludeUserWait);
    end;

    procedure CreateItemWithPostingSetup(var Item: Record Item; GenProdPostingGroup: Code[20]; VATProductPostingGroup: Code[20]; IncludeUserWait: Boolean)
    var
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    procedure CreateItemNoWithPostingSetup(GenProdPostingGroup: Code[20]; VATProductPostingGroup: Code[20]; IncludeUserWait: Boolean): Code[20]
    var
        Item: Record Item;
    begin
        CreateItemWithPostingSetup(Item, GenProdPostingGroup, VATProductPostingGroup, IncludeUserWait);
        exit(Item."No.");
    end;

    procedure CreateItemNoWithVATProdPostingGroup(VATProdPostGroupCode: Code[20]; IncludeUserWait: Boolean): Code[20]
    var
        Item: Record Item;
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
    ...
    begin
        ...
        NonstockItem.Validate("Vendor No.", LibraryPurchase.CreateVendorNo(false));
        NonstockItem.Validate(
    ...
    procedure CreateServiceTypeItem(var Item: Record Item; IncludeUserWait: Boolean)
    var
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    procedure CreateNonInventoryTypeItem(var Item: Record Item; IncludeUserWait: Boolean)
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    procedure CreateTrackedItem(var Item: Record Item; LotNos: Code[20]; SerialNos: Code[20]; ItemTrackingCode: Code[10]; IncludeUserWait: Boolean)
    var
        BCPTTestContext: Codeunit "BCPT Test Context";
    begin
        CreateItem(Item, IncludeUserWait);
    ...
    begin
        ...
        if InventoryPostingSetup.FindFirst() then
            exit(InventoryPostingSetup."Location Code");
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateItemJnlLineWithNoItem(var ItemJournalLine: Record "Item Journal Line"; ItemJournalBatch: Record "Item Journal Batch"; JournalTemplateName: Code[10]; JournalBatchName: Code[10]; EntryType: Enum "Item Ledger Entry Type")
    begin
    end;
