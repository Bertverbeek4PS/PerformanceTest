codeunit 80510 "PTK Library - Marketing 4PS"
{
    ...
    begin
        ...
        ContactBusinessRelation."No." := LibrarySales.CreateCustomerNo(false);
    ...
    begin
        CreateCompanyContact(Contact);
        LibrarySales.CreateCustomer(Customer, false);
    ...
    begin
        ...
        Opportunity.Validate(Description, Opportunity."No." + Opportunity."Contact No.");  // Validating No. as Description because value is not important.
